...
[GNU Make](make/README.md), [LLDB](lldb/README.md) and [tmux](tmux/README.md) manifests.
Assemble a new input directory containing `frozen-native-01`, `frozen-sdk-02`,
`frozen-resources`, `frozen-make-01`, `frozen-lldb-01` and `frozen-tmux-01`; do not append
to an earlier sealed input set.
...
Cuttlefish product. The tmux packaging candidate selects APEX version 6; unflagged
builds retain version1 and disabled compiler/tool modules. Version 5 added LLDB;
version4 added Make and version3 supplied
