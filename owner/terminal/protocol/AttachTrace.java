...
public final class AttachTrace {
    public enum Event {
        ...
        FDS_READY, FINISH_BEGIN, CURSOR_READY, TERMINAL_BEGIN, TERMINAL_END, CONNECTION_SET,
        PUBLISHED, READER_BEGIN, FRAME_READ, FRAME_APPLIED, READ_EOF, READ_EXCEPTION,
        RENEW_BEGIN, RENEW_OK, RENEW_FALSE, RENEW_EXCEPTION, RESIZE_QUEUED, RESIZE_BEGIN,
