...
An offline guest cannot prove connected privacy properties. Detailed inspection and
runtime records remain private; the public result is limited to the stated controls.

The later [connected baseline](../plans/2026-09-09-grapheneos-connected-baseline.md#product-findings)
